      ...
      <div className="w-full max-w-[460px] rounded-3xl bg-white shadow-lift-lg p-6">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            {parent && <p className="text-[15px] text-slate-500 mt-0.5">Under: {parent.title}</p>}
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label className="text-[14px] font-medium text-slate-700 mb-1.5 block">Title</label>
            <input
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-[16.5px] focus:outline-none focus:border-orange-400 resize-none"
            />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[14px] font-medium text-slate-700 mb-1.5 block">Priority</label>
              <select
            ...
            <div>
              <label className="text-[14px] font-medium text-slate-700 mb-1.5 block">Estimated hours</label>
              <input
                type="number" min="0" step="0.5"
                value={estimatedHours} onChange={(e) => setEstimatedHours(e.target.value)}
                placeholder="0" className="w-full h-10 rounded-xl border border-slate-200 bg-white px-3 text-[16.5px] focus:outline-none focus:border-orange-400"
              />
            </div>
          </div>
          <div>
            <label className="text-[14px] font-medium text-slate-700 mb-1.5 block">Due date</label>
            <div className="flex items-start gap-2">
              <input
                ...
                className="flex-1 min-w-0 h-10 rounded-xl border border-slate-200 bg-white px-3 text-[16.5px] focus:outline-none focus:border-orange-400"
              />
              <div className="shrink-0">
                <input
                  ...
                  className="w-[112px] h-10 rounded-xl border border-slate-200 bg-white px-3 text-[16.5px] focus:outline-none focus:border-orange-400 disabled:bg-slate-50 disabled:text-slate-400"
                />
          ...
          <div>
            <label className="text-[14px] font-medium text-slate-700 mb-1.5 block">Assignee</label>
            <select
          ...
          <div className="flex items-center gap-2 pt-2">
            <button type="button" onClick={onClose} className="flex-1 h-10 rounded-xl border border-slate-200 text-slate-700 text-[16.5px] font-medium hover:bg-slate-50">
              Cancel
            </button>
            <button type="submit" disabled={loading} className="flex-1 h-10 rounded-xl bg-orange-500 text-white text-[16.5px] font-medium hover:bg-orange-600 disabled:opacity-60">
